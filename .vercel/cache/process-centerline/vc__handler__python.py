...
__vc_spec = util.spec_from_file_location("api.process-centerline", "./api/process-centerline.py")
__vc_module = util.module_from_spec(__vc_spec)
sys.modules["api.process-centerline"] = __vc_module
...
if 'handler' in __vc_variables or 'Handler' in __vc_variables:
    ...
    print('Missing variable `handler` or `app` in file "api/process-centerline.py".')
    print('See the docs https://vercel.com/docs/runtimes#advanced-usage/advanced-python-usage')
    exit(1)
