...
class Centerline:
    def __init__(self, dictionary: Union[dict, str]) -> None:
    ...
    def splice(self, p1: Point, p2: Point) -> Union[LineString, Point]:
    ...
    def from_KP(self, KP: float) -> Union[Point, None]:
    ...
    def splice_KP(
        self, KP_beg: float, KP_end: float, crop=True
